...
e.default=r.extend({layout:t.default,tagName:"button",attributeBindings:["ariaChecked:aria-checked","role","dataAction:data-action","type","ariaLabel:aria-label","disabled","dataKeepDisabled:data-keep-disabled","ariaLabelledBy:aria-labelledby"],type:"button",ariaLabel:n.reads("label"),ariaChecked:n("checked",function(){return this.get("checked")?"true":"false"}),checked:!1,dataKeepDisabled:n.reads("disabled"),role:"switch",dataAction:"aria-switch",click:function(){this.toggleProperty("checked")}})}),define("ember-aria-switch/templates/components/aria-switch",["exports"],function(e){"use strict"
e.__esModule=!0,e.default=Ember.HTMLBars.template({id:"XAY25AII",block:'{"statements":[[11,"span",[]],[13],[0,"\\n  On\\n"],[14],[0,"\\n"],[11,"span",[]],[13],[0,"\\n  Off\\n"],[14],[0,"\\n"]],"locals":[],"named":[],"yields":[],"hasPartials":false}',meta:{moduleName:"ember-aria-switch/templates/components/aria-switch.hbs"}})}),define("ember-load-initializers/index",["exports"],function(e){"use strict"
